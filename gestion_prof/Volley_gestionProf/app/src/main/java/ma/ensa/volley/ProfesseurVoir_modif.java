...
////import ma.ensa.volley.adapter.AdapterProfesseur;
//
//public class ProfesseurVoir_modif extends AppCompatActivity {
//
//    /////////:spinner
//
//    private Spinner spinner;
//    private List<Professeur> filieresList = new ArrayList<>();
//    private RequestQueue requestQueue;
//
//    private String filieresUrl = "http://10.0.2.2:8083/api/v1/professeurs";
//    ////////////////
//
...
//                Intent intent = new Intent(ProfesseurVoir_modif.this, ProfesseurAdd.class);
...
//                Log.d("oki", response);
//                List<Professeur> students = parseStudentsData(response);
//                professeursAdapter = new AdapterProfesseur(ProfesseurVoir_modif.this, students);
//                idStudentsListView.setAdapter(professeursAdapter);
//
...
//    }
//
//    private List<Professeur> parseStudentsData(String response) {
//        List<Professeur> students = new ArrayList<>();
//        try {
